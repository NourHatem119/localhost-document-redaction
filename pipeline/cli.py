...
def run(input_path: str, output_path: str, use_llm: bool = False) -> str:
    ...
    if use_llm:
        ...
        all_spans = merge_spans(regex_spans, llm_spans)
...
def main():
    ...
    parser.add_argument("--use-llm", action="store_true", help="Enable LLM-based detection (requires EXO/Ollama)")
    args = parser.parse_args()

    run(args.input, args.output, use_llm=args.use_llm)
